...
from .step_arch import TSFormer, TSFormerSpatialTemporalMasking
...
# ================= model ================= #
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = "TSFormerSpatialTemporalMasking"
CFG.MODEL.ARCH = TSFormerSpatialTemporalMasking
CFG.MODEL.PARAM = {
    "patch_size":12,
    "in_channel":1,
    "embed_dim":96,
